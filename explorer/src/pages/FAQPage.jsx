    ...
    <div style={{ ...s.page, maxWidth: '780px', margin: '0 auto', padding: isMobile ? '16px' : '24px' }}>
      <SEO
        ...
        schema={{
          ...
          "@type": "FAQPage",
          "mainEntity": [
            { "@type": "Question", "name": "What is the Connectome Explorer?", "acceptedAnswer": { "@type": "Answer", "text": "The Connectome Explorer is an interactive research intelligence tool that lets you explore a knowledge graph built from open-access scientific papers. Unlike a search engine that just finds papers, this system extracts the scientific content from every paper — entities, claims, mechanisms, methods — and connects them into a living network." } },
            { "@type": "Question", "name": "Where does the data come from?", "acceptedAnswer": { "@type": "Answer", "text": "All papers come from open-access sources: PubMed Central, bioRxiv, and medRxiv. Every paper is legally available under Creative Commons licenses for text mining and computational analysis." } },
            { "@type": "Question", "name": "How is this different from PubMed, Google Scholar, or Semantic Scholar?", "acceptedAnswer": { "@type": "Answer", "text": "Those tools connect papers through citations. The Connectome Explorer connects papers through their scientific content. When two papers in different fields both study IL-6, they connect through the same entity node — whether or not either author has ever read the other's work." } },
            { "@type": "Question", "name": "Is the analysis AI-generated?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. Every extraction, connection, intelligence brief, and bridge hypothesis is generated by AI (primarily Claude by Anthropic) and clearly labeled as such. No AI output is presented as human review." } },
            { "@type": "Question", "name": "How are papers processed?", "acceptedAnswer": { "@type": "Answer", "text": "Every paper goes through a six-stage pipeline: Ingest, Extract, Graph, Connect, Critique, and Explore." } },
            { "@type": "Question", "name": "How are connections discovered?", "acceptedAnswer": { "@type": "Answer", "text": "Connections come from three sources: graph traversal (shared entities, mechanisms, methods), embedding similarity (semantically similar content), and AI validation (verifies candidates, assigns confidence and novelty scores)." } },
            { "@type": "Question", "name": "What do the confidence and novelty scores mean?", "acceptedAnswer": { "@type": "Answer", "text": "Confidence (0.0-1.0) reflects how much evidence supports a connection. Novelty (0.0-1.0) reflects how surprising the connection is. The most interesting connections are often high confidence + high novelty." } },
            { "@type": "Question", "name": "How do I find a specific paper?", "acceptedAnswer": { "@type": "Answer", "text": "Go to the Papers page and use the search bar. You can search by title, author, or keyword, and filter by source." } },
            { "@type": "Question", "name": "How do I use Bridge Query?", "acceptedAnswer": { "@type": "Answer", "text": "Go to Bridge, enter two research concepts, and submit. The system searches the knowledge graph for paths connecting them with confidence scores and plain-language hypotheses." } },
            { "@type": "Question", "name": "Do I need an account?", "acceptedAnswer": { "@type": "Answer", "text": "Most features work without signing in. An account unlocks the Workspace and the Analyze feature for submitting new papers." } },
            { "@type": "Question", "name": "How accurate are the AI extractions?", "acceptedAnswer": { "@type": "Answer", "text": "AI extraction is imperfect. The system compensates with confidence scores, multiple validation layers, and honest labeling. Researchers should always verify claims against original papers." } },
            { "@type": "Question", "name": "Should I trust the Intelligence Briefs?", "acceptedAnswer": { "@type": "Answer", "text": "Intelligence Briefs are analytical tools, not peer review. Use them as a starting point for deeper investigation." } },
            { "@type": "Question", "name": "What are the system's biggest limitations?", "acceptedAnswer": { "@type": "Answer", "text": "Open-access only, seed domain focus on neuroscience, AI limitations in entity normalization and mechanism extraction, and processing lag for recent papers." } }
          ]
        }}
      />
      {/* Hero */}
